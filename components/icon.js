      ...
      return (
        <>
          <svg
            ...
            width="210.000000pt"
            height="165.000000pt"
            viewBox="0 0 210.000000 165.000000"
          ...
          >
            ...
            >
              <path
              fill={color}
              d="M1009 1497 l-43 -87 38 -72 c22 -40 42 -84 47 -98 4 -15 8 -18 8 -8
1 9 19 53 40 98 44 91 45 84 -12 189 l-35 65 -43 -87z"
              />
              <path
              fill={color}
              d="M1160 1368 c0 -3 13 -35 30 -70 56 -117 38 -182 -73 -266 l-57 -43 0
-77 c0 -72 1 -75 16 -54 8 12 36 33 62 46 142 72 160 206 54 411 -17 33 -31
57 -32 53z"
              />
              <path
              fill={color}
              d="M890 1265 c-77 -180 -56 -283 74 -359 36 -21 67 -45 69 -55 3 -9 5
21 6 66 l1 82 -54 35 c-91 58 -119 128 -88 220 23 67 19 73 -8 11z"
              />
              <path
              fill={color}
              d="M813 733 c-18 -7 -16 -50 3 -57 25 -10 33 -7 44 13 7 15 6 23 -6 35
-16 17 -21 18 -41 9z"
              />
              <path
              fill={color}
              d="M931 721 c-15 -27 9 -56 37 -47 39 13 24 66 -18 66 -5 0 -14 -8 -19
-19z"
              />
              <path
              fill={color}
              d="M185 610 c3 -5 13 -10 20 -10 22 0 26 -32 23 -190 -3 -139 -4 -145
-25 -155 -41 -18 -24 -25 57 -25 47 0 80 4 80 10 0 6 -7 10 -15 10 -24 0 -36
37 -33 108 l3 67 93 3 92 3 0 -85 c0 -83 -1 -86 -25 -92 -51 -13 -23 -24 60
-24 47 0 85 4 85 9 0 5 -10 11 -22 13 -23 3 -23 5 -26 170 l-2 167 27 15 c27
14 24 15 -62 15 -85 0 -89 -1 -62 -15 25 -14 27 -19 27 -85 l0 -70 -92 3 -93
3 -3 40 c-6 66 5 100 36 112 23 9 13 11 -61 12 -57 1 -86 -3 -82 -9z"
              />
              <path
              fill={color}
              d="M685 608 c40 -22 45 -38 45 -161 0 -135 11 -171 63 -202 45 -27 136
-27 174 1 46 34 63 79 63 170 0 131 9 173 39 189 24 13 21 14 -49 15 l-75 0
33 -20 32 -20 0 -115 c0 -166 -21 -205 -107 -205 -85 0 -113 51 -113 204 0
112 5 136 25 136 8 0 17 5 20 10 4 6 -26 10 -82 10 -69 -1 -84 -3 -68 -12z"
              />
              <path
              fill={color}
              d="M1165 608 c41 -22 45 -37 45 -174 0 -145 -8 -184 -40 -184 -11 0 -20
-4 -20 -10 0 -6 35 -10 85 -10 86 0 104 7 63 25 -20 9 -23 19 -26 78 -3 66 -3
67 23 67 20 0 31 -10 53 -47 47 -81 82 -114 130 -120 45 -6 54 4 22 25 -21 13
-110 143 -110 160 0 5 11 14 24 21 41 22 59 88 36 132 -21 38 -62 49 -187 49
-91 -1 -113 -3 -98 -12z m204 -34 c49 -62 11 -154 -64 -154 l-35 0 0 83 c0 46
3 87 7 90 3 4 21 7 39 7 23 0 38 -8 53 -26z"
              />
              <path
              fill={color}
              d="M1598 608 c31 -15 33 -31 30 -198 -3 -139 -4 -145 -25 -155 -42 -18
-24 -25 62 -25 47 0 85 4 85 9 0 5 -10 11 -22 13 -27 4 -38 40 -31 102 4 34
10 46 22 46 25 0 35 -11 70 -73 38 -67 64 -87 123 -94 l43 -4 -27 23 c-15 13
-47 54 -72 92 l-46 70 35 32 c47 43 51 101 9 144 -23 24 -31 25 -152 27 -101
2 -122 0 -104 -9z m192 -28 c14 -14 20 -33 20 -65 0 -56 -33 -95 -79 -95 -27
0 -29 3 -33 45 -2 25 -2 65 0 90 4 44 5 45 38 45 21 0 42 -8 54 -20z"
              />
            </g>
          </svg>
        </>
